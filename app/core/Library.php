...
class Library {
     ...
     * @param $location
     */
    public function returnheader($location){
    ...
    public function secureInput($input) {
        return mysql_real_escape_string(htmlentities(stripslashes(trim($input))));
    }
     ...
     * @return bool|string
     */
    public function pass_hashing($password){
     ...
     * @return bool|string
     */
    public function imageupload($ImageNamePrefix,$ImageFile,$ImagePath){
        ############ Edit settings ##############
